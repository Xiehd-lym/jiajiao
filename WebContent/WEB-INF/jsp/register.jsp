...
<html>
	<head>
		...
		<title>【云朵家教网】莆田家教网_免费找家教_莆田家教一对一在线辅导,莆田领先的家教辅导服务专业平台</title>
		...
		<div class="header_i min_1200">
			<div class="w_1200">
				<h1 class="logo fl png_img">
					<a href="<%=basePath %>"><img
							src="<%=basePath%>static/img/logo2.png" alt="云朵家教">
					</a>
				</h1>
				...
				<div class="login_fill @*tab_box*@">
					<div id="mobilereg">
						...
						<div class="login_o_l orange_link">
							<div class="treaty">
								当前注册城市:
								<a href="javascript:void(0);" target="_blank">莆田</a>
							</div>
						</div>
		...
		<div class="min_1200 footer_i clearfix">
			<div class="w_1200">
				<span class="fr"><a href="javascript:void(0)">XX安备 XXXXXXXXXX号</a>
					...
					href="javascript:void(0)">沪ICP备15011267号</a>
				</span>
			</div>
		</div>
		<!--end文件底-->
